...
Create an Account
 ...
 # ou avec xpath:/html/body/div[2]/header/div[1]/div/ul/li[3]/
    ...
    input text  id:email_address   Assoma.Quessonn@gmail.com
...
Sign In
    ...
    input text  id:email    Assoma.Quessonn@gmail.com
    ...
    sleep   3
    click button    //*[@id="checkout-payment-method-load"]/div/div/div[2]/div[2]/div[4]/div/button  #place order
    sleep   5
